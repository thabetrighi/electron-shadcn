  ...
  fr: {
    translation: {
      ...
      orders: {
        ...
        loadingInPOS: "Chargement de la commande en POS...",
        duplicated: "Commande dupliquée avec succès",
        duplicateFailed: "Échec de duplication de la commande",
        exported: "Données de commande exportées avec succès",
        exportFailed: "Échec d'exportation des données de commande",
        orderInformation: "Informations de commande",
        customerInformation: "Informations client",
        financialSummary: "Résumé financier",
        orderStatistics: "Statistiques de commande",
