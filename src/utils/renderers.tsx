...
export const renderStatus = (status: string) => {
  ...
  return (
    <Badge variant="outline" className={`${config.color} border`}>
      <Icon className="mr-1 h-3 w-3 rtl:mr-0 rtl:ml-1" />
...
export const renderDateTime = (date: string | Date | null | undefined) => {
  if (!date) return <span className="text-gray-400">-</span>;
  return <span className="text-gray-900">{formatDateTime(date)}</span>;
};
...
export const renderPhone = (phone: string) => {
  ...
  return (
    <div className="flex items-center">
      <Phone className="mr-1 h-3 w-3 text-gray-400 rtl:mr-0 rtl:ml-1" />
...
export const renderEmail = (email: string) => {
  ...
  return (
    <div className="flex items-center">
      <Mail className="mr-1 h-3 w-3 text-gray-400 rtl:mr-0 rtl:ml-1" />
